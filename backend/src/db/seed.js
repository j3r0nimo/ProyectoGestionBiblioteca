...
try {       
    ...
    const librosInsertar = await Libro.insertMany([        
        ...
        {                                             //id[5]  
            ...
            anio: 2015,
            paginas: 206,
            portadaImagePath: "/uploads/Conversando_sobre_economia_com_a_minha_filha_varoufakis_2015.jpg"
        },
        {                                             //id[6]  
            tipo: "Libro",
            isbn: "84-8372-187-2",
